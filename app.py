...
with st.sidebar:
    ...
    if secret_key:
        # Use secret key automatically without showing the input field
        api_key = secret_key
        st.sidebar.success("🔑 API Key configured via secrets!")
    else:
        # Fall back to manual input if no secret is saved
